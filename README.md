...
We aim to take care of our styling and functionality ( Front-end + Back-end)

We aim to perform the CRUD operation ( Create+Read+Update+Delete)

We aim to implement the ethics of autonomous learning and self-reliability. 
...
- [ ] Prepare for 1 minute pitch @ demo on Wednesday Morning
